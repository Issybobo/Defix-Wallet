...
const Start = () => {
  ...
  return (
    ...
    <div className="mt-5 text-white font-light text-2xl md:w-9/12 w-11/12 text-left">
...
<div className="grid sm:grid-cols-5 grid-cols-2 w-full mt-14  border-t-4 border-r- border-b-4 border-l-4" ></div>
           ...
           <div className={`rounded-br-2xl ${companyCommonStyles}`}>
            ...
            <div>
            <img src={hero2} alt="hero image" style={{ display: 'inline-block ' }} />
              <img src={hero1} alt="hero image" style={{ display: 'inline-block ' }} />
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            <Input placeholder="Enter Message" name="description" type="text" handleChange={handleChange} />
          ...
          <div>
             ...
             <img src={crypto} alt="crypto image" style={{ display: 'inline-block' }} />
 
             <img src={wallet} alt="wallet image" style={{ display: 'inline-block' }} />
 
             <img src={currency} alt="currency image" style={{ display: 'inline-block' }} />
